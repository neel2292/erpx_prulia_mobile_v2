...
export class LoginPage {
  ...
  forgotPass() {
    let forgot = this.modalCtrl.create(ForgotPasswordPage, {}, { cssClass: 'forgot-password-popup' });
    forgot.present();

    // let forgot = this.alertCtrl.create({
    //   title: 'Forgot Password?',
    //   message: "Enter your Prudential ID and NRIC Number so we can send you temporary password.",
    //   inputs: [
    //     {
    //       name: 'prulia_id',
    //       placeholder: 'Prudential ID (eg: 1234567)',
    //       type: 'string'
    //     }, {
    //       name: 'nric_id',
