...
var EventPage = (function () {
    ...
    EventPage.prototype.doRefresh = function (refresher) {
        this._updateSchedule(true, false, (function (data) { refresher.complete(); }), (function (data) { refresher.complete(); }));
    };
...
var EventDetailPage = (function () {
    ...
    EventDetailPage.prototype.update = function () {
        var myModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_2__event_pref_event_pref__["a" /* EventPrefPage */], { 'value': this.eventProvider.listings[this.eventIter], mode: 'Update' });
        myModal.present();
    };
...
var NewsletterPage = (function () {
    ...
    NewsletterPage.prototype.doRefresh = function (refresher) {
        this._updateNewsletter(true, false, (function (data) { refresher.complete(); }), (function (data) { refresher.complete(); }));
    };
...
var PartnerPage = (function () {
    ...
    PartnerPage.prototype.doRefresh = function (refresher) {
        this._updatePartner(true, false, (function (data) { refresher.complete(); }), (function (data) { refresher.complete(); }));
    };
...
var AuthServiceProvider = (function () {
    ...
    AuthServiceProvider.prototype.login = function (username, password) {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.common.get_api_url('/api/method/login'), credentials, { observe: 'response', withCredentials: true })
                .subscribe(function (res) {
                debugger;
                // if(document.cookie !== ""){
    ...
    AuthServiceProvider.prototype.if_session_valid = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.common.get_api_url('/api/method/frappe.auth.get_logged_user'), { observe: 'response', withCredentials: true })
                .subscribe(function (res) {
                resolve(res.body);
            }, function (err) {
                reject(err);
    ...
    AuthServiceProvider.prototype.reset_password = function (email) {
        ...
        var data = { user: email };
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.common.get_api_url('/api/method/frappe.core.doctype.user.user.reset_password'), data, { observe: 'response', withCredentials: true })
                .subscribe(function (res) {
                resolve(res.body);
            }, function (err) {
                reject(err);
    ...
    AuthServiceProvider.prototype.forget_password = function (prulia_id, nric_number) {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.common.get_api_url('/api/method/erpx_prulia.prulia_members.doctype.prulia_member.prulia_member.forget_password'), data, { observe: 'response', withCredentials: true })
                .subscribe(function (res) {
                resolve(res.body);
            }, function (err) {
                reject(err);
